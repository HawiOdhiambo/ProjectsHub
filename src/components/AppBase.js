...
class AppBase extends Component{
 ...
 render(){
  ...
  const { homepage,countryPage,countryProjectPage, homepageProjectPage,
    //projectTitleLocation, p_idLocation, 
    markerLocation, pageLocation,
    displayFilterCountryPage, displayFilterResults, displayErrorMessage,
     //displayFilterProjectPage, displayFilterCountryProjectPage 
    }=this.state;
    ...
    const projectTitleLocation="Cities and Climate Change Initiative";
    const p_idLocation="3";
    
    const {displayFilterProjectPage, displayFilterCountryProjectPage }= this.props;
