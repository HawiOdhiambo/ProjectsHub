...
class FilterCountryPage extends React.Component{
	constructor(props){
      ...
      this.displayFilterCountryProjectPage=this.displayFilterCountryProjectPage.bind(this)
                    ...
                    <div className="col-sm-12">
			         ...
			         <div className='container'>
				            <div className='row'>
                              ...
                              donorName={this.donorName} projectTitle={this.projectName} callingPage="countryPage" mapStyle={mapStyle}/>
				                    ...
				                    <div className='col-sm-6' >
				                      ...
				                      <ProjectsCard location={this.props.location} countryName={this.props.markerLocation}  unitName={this.unitName} ongoingClosedValue={this.ongoingClosedValue} 
                          ...
                          <div className="container">
                            ...
                            <FetchFilterSummary countryName={this.props.markerLocation}  unitName={this.unitName} ongoingClosedValue={this.ongoingClosedValue} 
                              donorName={this.donorName} projectTitle={this.projectName} />
              
                            
                            <FetchFilterCharts countryName={this.props.markerLocation}  unitName={this.unitName} ongoingClosedValue={this.ongoingClosedValue} 
                              donorName={this.donorName} projectTitle={this.projectName} 
                                     handleDisplayProjectPage={this.displayFilterCountryProjectPage}/>
                          </div>
				              </div>
						</div>)
				}
